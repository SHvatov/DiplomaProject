...
contains
    ...
    subroutine calculateDiscrepancy(roMeshMatr, psiVector)
        ...
        complex(8), dimension(1:EXTENDED_MESH_DIM), intent(out) :: psiVector
        integer :: i

        ! DECLARATIONS
        ! i = 0
        complex(8), dimension(0:3) :: leftMain
        complex(8), dimension(0:3) :: leftConjg

        ! i = [1; Nr - 1]
        complex(8), dimension(0:3, 1:N-1) :: main
        complex(8), dimension(0:3, 1:N-1) :: mainConjg

        ! i = Nr
        complex(8), dimension(0:3) :: rightMain
        complex(8), dimension(0:3) :: rightConjg
    ...
    function calculateA3(roMeshMatr, i) result(retval)
        ...
        retval = &
            ( &
                ...
                + IMG_UNIT * Omega2Conjg(i) * Ro23Point(roMeshMatr, i) &
                - IMG_UNIT * Omega2(i) * Ro23PointConjg(roMeshMatr, i) &
                + GammaSP * Ro33Point(roMeshMatr, i) &
            )
    ...
    function calculateA3Conjg(roMeshMatr, i) result(retval)
        ...
        retval = &
            ( &
                ...
                - IMG_UNIT * Omega2(i) * Ro23PointConjg(roMeshMatr, i) &
                + IMG_UNIT * Omega2Conjg(i) * Ro23Point(roMeshMatr, i) &
                + GammaSP * Ro33PointConjg(roMeshMatr, i) &
            )
