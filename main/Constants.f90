module Constants
    ...
    complex(8), parameter :: IMG_UNIT = (0, 1)
    ...
    complex(8), parameter :: C1 = (3.0e5, 0.0)
    complex(8), parameter :: C2 = (3.0e5, 0.0)
    real(8), parameter :: AC = 1.4

    complex(8), parameter :: DeltaStroke11 = IMG_UNIT * Delta1 + Gamma
    complex(8), parameter :: DeltaStroke12 = -IMG_UNIT * Delta1 + Gamma
